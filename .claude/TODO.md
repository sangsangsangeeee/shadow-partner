...
### iOS 백그라운드에서 훈련이 멈춘다 (2026-09-06 기기 확인). **아직 안 고쳤다**
...
**무엇을 할지는 정해지지 않았다.** 후보는 셋이고 기획 판단이 필요하다 —
백그라운드로 가면 일시정지 / 돌아올 때 벽시계로 맞추기 / 그대로 두기.
**안드로이드는 아직 안 봤다.** 정책이 달라서 거기서는 계속 돌 수도 있고,
그렇다면 한쪽에서 되는 것을 양쪽에서 끄는 셈이 된다.
